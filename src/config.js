...
//
// =================================================================
//  이 파일 하나만 수정하면 포트폴리오 사이트의 모든 내용이 바뀍니다.
// =================================================================
...
export const PROFILE = {
  nameKo:      '홍길동',              // 한글 이름 (희드, Navbar 로고)
  name:        'Hong Gildong',        // 영문 이름
...
export const ABOUT = {
  ...
  paragraphs: [
    ...
    'C++20 기반 렌더링 파이프라인 설계, Unreal Engine 5 클라이언트 개발, 채팅/매칭 백엔드 구축까지 시스템의 전체를 직접 설계하고 구현합니다.',
...
export const PROJECTS = [
  {
    ...
    image:  null,         // 이미지 파일명 (public/ 폴더 기준) 또는 null
    github: 'https://github.com/your-github-id/proto-engine',
    demo:   null,
    metric: null,         // 예) '4.8★ (2.1만 다운)'
  },
  {
    id:     'game-sync-server',
  ...
  },
  {
    ...
    desc:   '실시간 GLSL 컴파일 및 렌더링을 지원하는 웹 기반 셰이더 엔디터. Uniforms GUI, PBR 예제 번들, 코드 공유 URL 생성 기능을 포함합니다.',
    image:  null,
...
export const COVER_LETTER = {
  sections: [
    ...
    {
      title: '품질에 대한 강박함',
      body:  '라이브 서비스 도중 클라이언트 메모리가 매주 30% 이상 누수되는 문제를 주도적으로 잡아냈습니다. 버그를 수정하는 것에서 그치지 않고, 매크로를 통한 상세 프로파일링으로 실질적인 레이어의 메모리 사용량을 적췀해 성능을 30% 개선했습니다.',
    },
    {
